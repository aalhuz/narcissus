...
/* Abeer commented this and added the next func
...
//    return s;
    ...
    for (var i in this) {
        if (this.hasOwnProperty(i) && i != 'type' && i != 'target' &&
            i != 'end' && i != 'lineno' && i != 'start' && i != 'tokenizer' &&
            i != 'length' && i != 'assignOp' && this[i] != null && this[i] != 'null')
            a.push({id: i, value: this[i]});
    }
    a.sort(function (a,b) { return (a.id < b.id) ? -1 : 1; });
   INDENTATION = "    ";
...
//Abeer OLD Np.__defineGetter__('filename',
